...
AudioOutputI2S           outputsound;       //xy=334,393
...
void loop() {
  ...
  Serial.print(sinceTest1);
  Serial.println(" ms to play S.wav using while isPlaying statement");
  ...
  Serial.print(sinceTest1);
  Serial.println(" ms to play OH.wav using while isPlaying statement");
